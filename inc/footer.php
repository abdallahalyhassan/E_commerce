                    ...
                    <div class="widgets_container widget_menu">
                        ...
                        <div class="footer_menu">
                            <ul>
                                ...
                                <li><a href="../routes/web.php?page=blog">Delivery Information</a></li>
                                <li><a href="../routes/web.php?page=contact">Privacy Policy</a></li>
                                <li><a href="../routes/web.php?page=services">Terms & Conditions</a></li>
                    ...
                    <div class="widgets_container widget_menu">
                        ...
                        <div class="footer_menu">
                            <ul>
                                ...
                                <li><a href="../routes/web.php?page=wishlist">Wish List</a></li>
                                <li><a href="#">Newsletter</a></li>
                                <li><a href="#">Affiliate</a></li>
                                <li><a href="../routes/web.php?page=faq">International Orders</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer_payment text-right">
                            <a href="#"><img src="../public/assets/img/icon/payment.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
